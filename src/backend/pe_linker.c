...
static void generate_machine_code(PeLinker* linker, SirModule* module) {
    ...
    for (int pass = 0; pass < 2; pass++) {
        ...
        uint8_t print_int_code[] = {
            0x48, 0x83, 0xEC, 0x68, 0x49, 0x89, 0xCA, 0x4D, 0x31, 0xDB, 0x48, 0x85, 0xC9, 0x79, 0x07, 0x49,
            ...
            0xC0, 0x75, 0xEC, 0x4D, 0x85, 0xDB, 0x74, 0x04, 0x41, 0xC6, 0x00, 0x2D, 0x49, 0xFF, 0xC8, 0x49,
