...
void pe_builtins_generate(PeLinker* linker, uint32_t princeps_offset, uint32_t init_offset) {
    ...
    // mov r8d, dword ptr [rsp+56] (nNumberOfBytesToWrite)
    emit_rex(&linker->text_section, 0, 1, 0, 0); emit8(&linker->text_section, 0x8B); emit8(&linker->text_section, 0x44); emit8(&linker->text_section, 0x24); emit8(&linker->text_section, 0x38);
    ...
    uint8_t print_uint_code[] = {
        ...
        0x24, 0x58, 0x44, 0x8B, 0x44, 0x24, 0x60, 0x4C, 0x8D, 0x4C, 0x24, 0x28, 0x48, 0xC7, 0x44, 0x24,
    ...
    uint8_t print_int_code[] = {
        ...
        0x54, 0x24, 0x58, 0x44, 0x8B, 0x44, 0x24, 0x60, 0x4C, 0x8D, 0x4C, 0x24, 0x28, 0x48, 0xC7, 0x44,
